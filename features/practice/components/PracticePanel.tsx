...
export function PracticePanel({ exercise, scale, ragas, tonic, tempo, activeIndex, isPlaying, audioError, instrument, isLoadingAudio, countInBeat, countInEnabled, isTanpuraEnabled, tanpuraVolume, tanpuraError, onInstrumentChange, onRagaChange, onTonicChange, onTempoChange, onCountInToggle, onTanpuraToggle, onTanpuraVolumeChange, onPlayTone, onPlay, onStop }: Props) {
  return (
    <div className="practicePanel">
      <div className="practiceHeader">
        ...
        <div className="settings">
          <p className="settingsTitle">Practice settings</p>
